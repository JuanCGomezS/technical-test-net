...
namespace FBProject.Migrations
{
    ...
    [Migration("20230622171411_v1.0.5")]
    partial class v105
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FBProject.Models.Producto", b =>
                {
                    ...
                    b.Property<int?>("Venta_ProductoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FBProject.Models.Producto", b =>
                {
                    b.HasOne("FBProject.Models.Venta_Producto", null)
                        .WithMany("Productos")
                        .HasForeignKey("Venta_ProductoId");
                });
